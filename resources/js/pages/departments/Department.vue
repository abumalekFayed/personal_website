<template>
    <v-card>
        ...
        <div
            class="d-flex align-center justify-center flex-wrap mt-10"
            style="gap:10px"
        >
            <v-hover v-slot="{ hover }">
                <v-card
                    style="gap:20px;width:250px"
                ...
                >
                    <v-card-title
                        style="gap:20px"
                        v-if="department.file_type == 'video'"
                    ...
                    <v-card-actions v-if="$auth.check()" class="justify-center">
                        <v-chip
                            small
                            class="mx-2"
                            @click.stop="editDepartmentItem(item)"
                            >تعديل</v-chip
                        >
                        <v-chip
                            small
                            color="error"
                            @click.stop="deleteDepartmentItem(item.id)"
                            >حذف</v-chip
                        >
                    </v-card-actions>
                    <v-expand-transition>
                        <div
                            ...
                            grey darken-1 v-card--reveal text-h2 white--text"
                            style="height: 100%;"
                        >
        ...
        <d-dialog
            v-model="show_add_item"
            width="500px"
            title="اضافة"
            @save="saveDepartmentItem"
        >
            <v-text-field
                outlined
                dense
            ...
            />
            <v-file-input
                v-if="department.file_type == 'image'"
                clearable
                prepend-icon=""
