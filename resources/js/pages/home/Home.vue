<template>
	<div>
		<v-row>
			<v-col cols="12">
				<div outlined class="justify-center d-flex align-center flex-column  primary--text">
					<!-- <h2 class="ma-2 white--text">
                    موقع النائب خالد العتيبي
                </h2> -->

					<img src="imgs/start2.jpg" alt="img" width="80%" style="border-radius:30px">
				</div>
		...
		<v-row>
			<v-col cols="12" sm="6" md="4" v-for="department in activeDepartments" :key="department.id">
				<v-card outlined :class="department.color" :to="'/departments/'+ department.id">
					<v-card-title primary-title class="justify-center white--text">{{department.name}}
						<!-- <v-spacer></v-spacer>
