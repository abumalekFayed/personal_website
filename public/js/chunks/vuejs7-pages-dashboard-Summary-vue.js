(self["webpackChunk"] = self["webpackChunk"] || []).push([["vuejs7-pages-dashboard-Summary-vue"],{

/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/dashboard/Summary.vue?vue&type=script&lang=js&":
/*!*******************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/dashboard/Summary.vue?vue&type=script&lang=js& ***!
  \*******************************************************************************************************************************************************************************************************************/
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  data: function data() {
    ...
    return _ref = {
      ...
      selected_purchase_month: '',
      selected_payment_date: 0
    }, _defineProperty(_ref, "selected_purchase_date", 0), _defineProperty(_ref, "step", '1'), _defineProperty(_ref, "stackedOptions", {
      tooltips: {
        mode: 'index',
        intersect: false
      },
  ...
  computed: {
    year_total_sales: function year_total_sales() {
      if (!this.dashboard.year_sales) return 0;
      return this.dashboard.year_sales.reduce(function (a, b) {
        return a + parseInt(b.value);
      }, 0);
    },
    year_total_purchases: function year_total_purchases() {
      if (!this.dashboard.year_purchases) return 0;
      return this.dashboard.year_purchases.reduce(function (a, b) {
        return a + parseInt(b.value);
      }, 0);
    },
    year_total_sale_taxes: function year_total_sale_taxes() {
      if (!this.dashboard.year_sales) return 0;
      return this.dashboard.year_sales.reduce(function (a, b) {
        return a + parseInt(b.t_value);
      }, 0);
    },
    year_total_purchase_taxes: function year_total_purchase_taxes() {
      if (!this.dashboard.year_purchases) return 0;
      return this.dashboard.year_purchases.reduce(function (a, b) {
        return a + parseInt(b.t_value);
      }, 0);
    },
    dateSales: function dateSales() {
      if (!this.dashboard.month_sales) return 0;
      return;
    },
    salesChart2: function salesChart2() {
      return {
        labels: ['مبيعات', 'مشتريات', 'صافي'],
        datasets: [{
          data: [this.year_total_sales, this.year_total_purchases, this.year_total_sales - this.year_total_purchases],
          backgroundColor: ["#42A5F5", "#66BB6A", "#FFA726"],
          hoverBackgroundColor: ["#64B5F6", "#81C784", "#FFB74D"]
        }]
      };
    },
    salesChart3: function salesChart3() {
      return {
        labels: ['ضريبة مبيعات', 'ضريبة مشتريات', 'الفرق'],
        datasets: [{
          data: [this.year_total_sale_taxes, this.year_total_purchase_taxes, this.year_total_sale_taxes - this.year_total_purchase_taxes],
          backgroundColor: ["#42A5F5", "#66BB6A", "#FFA726"],
          hoverBackgroundColor: ["#64B5F6", "#81C784", "#FFB74D"]
        }]
      };
    },
    salesChart: function salesChart() {
      if (!this.dashboard.year_sales) return {};
      return {
        labels: this.dashboard.year_sales.map(function (m) {
          return m.new_date;
        }),
        datasets: [{
          type: 'bar',
          ...
          data: this.dashboard.year_sales.map(function (m) {
            return m.value;
          })
        }, {
          type: 'bar',
    ...
    PurchasesChart: function PurchasesChart() {
      if (!this.dashboard.year_purchases) return {};
      return {
        labels: this.dashboard.year_purchases.map(function (m) {
          return m.new_date;
        }),
        datasets: [{
          type: 'bar',
          label: 'مشتريات',
          backgroundColor: '#0a9c62',
          data: this.dashboard.year_purchases.map(function (m) {
            return m.value;
          })
        }, {
          type: 'bar',
    ...
    month: function month() {
      if (!this.dashboard.month_sales) return {};
      return {
        labels: this.dashboard.month_sales.map(function (m) {
          return m.new_date;
        }),
        datasets: [{
          label: 'My First dataset',
          backgroundColor: '#42A5F5',
          data: this.dashboard.month_sales.map(function (m) {
            return m.value;
          })
        }]
      };
  ...
  methods: {
    loadData: function loadData() {
      ...
      this.axios.get('dashboard').then(function (res) {
        _this.dashboard = res.data;
        _this.selected_date = _this.dashboard.month_sales.length > 0 ? _this.dashboard.month_sales[0] : '';
        _this.selected_month = _this.dashboard.year_sales.length > 0 ? _this.dashboard.year_sales[0] : '';
        _this.selected_purchase_date = _this.dashboard.month_purchases.length > 0 ? _this.dashboard.month_purchases[0] : '';
        _this.selected_purchase_month = _this.dashboard.year_purchases.length > 0 ? _this.dashboard.year_purchases[0] : '';
      });
    },
    fetchData: function fetchData(type, prop) {
      var _this2 = this;

      var variabls = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : '';
      var options = {
        type: type,
        prop: prop,
        variabls: variabls
      };
      axios.post('dashboard-custom', options).then(function (res) {
        _this2.dashboard[prop] = res.data;
      });
    }
  }
});
...
/***/ "./resources/js/pages/dashboard/Summary.vue?vue&type=script&lang=js&":
/*!***************************************************************************!*\
  !*** ./resources/js/pages/dashboard/Summary.vue?vue&type=script&lang=js& ***!
  \***************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./resources/js/pages/dashboard/Summary.vue?vue&type=template&id=a173011c&scoped=true&":
/*!*********************************************************************************************!*\
  !*** ./resources/js/pages/dashboard/Summary.vue?vue&type=template&id=a173011c&scoped=true& ***!
  \*********************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "render": () => (/* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_Summary_vue_vue_type_template_id_a173011c_scoped_true___WEBPACK_IMPORTED_MODULE_0__.render),
/* harmony export */   "staticRenderFns": () => (/* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_Summary_vue_vue_type_template_id_a173011c_scoped_true___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns)
/* harmony export */ });
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_Summary_vue_vue_type_template_id_a173011c_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./Summary.vue?vue&type=template&id=a173011c&scoped=true& */ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/dashboard/Summary.vue?vue&type=template&id=a173011c&scoped=true&");


/***/ }),

/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/dashboard/Summary.vue?vue&type=template&id=a173011c&scoped=true&":
/*!************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/dashboard/Summary.vue?vue&type=template&id=a173011c&scoped=true& ***!
  \************************************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
        ...
        [
          ...
          _c(
            ...
            [
                ...
                [
                  _c(
                          ...
                          fn: function() {
                            return [
                              _c("v-select", {
                                ...
                                attrs: {
                                  "hide-details": "",
                                  items: _vm.dashboard.month_sales,
                                  "item-text": "new_date",
                                  "return-object": "",
                                  outlined: "",
                                  dense: ""
                    ...
                    [
                      ...
                      _c("span", { staticClass: "title primary--text" }, [
                        _vm._v(" " + _vm._s(_vm.selected_date.value))
                      ]),
                      _vm._v(" |\n\t\t\t\t\t"),
                      _c("span", { staticClass: "title error--text" }, [
                        _vm._v(" " + _vm._s(_vm.selected_date.t_value))
                      ])
                    ]
                  ),
                  _vm._v(" "),
                  _c(
                          ...
                          fn: function() {
                            return [
                              _c("v-select", {
                                ...
                                attrs: {
                                  "hide-details": "",
                                  items: _vm.dashboard.year_sales,
                                  "item-text": "new_date",
                                  "return-object": "",
                                  outlined: "",
                                  dense: ""
                    ...
                    [
                      _vm._v(" "),
                      _c("span", { staticClass: "title primary--text" }, [
                        _vm._v(" " + _vm._s(_vm.selected_month.value))
                      ]),
                      _vm._v(" |\n\t\t\t\t\t"),
                      _c("span", { staticClass: "title error--text" }, [
                        _vm._v(" " + _vm._s(_vm.selected_month.t_value))
                      ])
                    ]
                  ),
                  _vm._v(" "),
                  _c("d-panel", { attrs: { title: "مبيعات العام" } }, [
                    _c("span", { staticClass: "title primary--text" }, [
                      _vm._v(
                        " " +
                          _vm._s(
                            _vm.dashboard.year_sales
                              ? _vm.dashboard.year_sales.reduce(function(a, b) {
                                  return a + parseInt(b.value)
                                }, 0)
                              : 0
                          )
              ...
              _vm._v(" "),
              _c("v-col", {
                staticClass: "justify-center d-flex align-center",
                ...
                [
                  _c(
                          ...
                          fn: function() {
                            return [
                              _c("v-select", {
                                ...
                                attrs: {
                                  "hide-details": "",
                                  items: _vm.dashboard.month_purchases,
                                  "item-text": "new_date",
                                  "return-object": "",
                                  outlined: "",
                                  dense: ""
                                ...
                                model: {
                                  value: _vm.selected_purchase_date,
                                  callback: function($$v) {
                                    _vm.selected_purchase_date = $$v
                                  },
                                  expression: "selected_purchase_date"
                                }
                              })
                            ]
                          },
                    ...
                    [
                      _vm._v(" "),
                      _c("span", { staticClass: "title primary--text" }, [
                        _vm._v(" " + _vm._s(_vm.selected_purchase_date.value))
                      ]),
                      _vm._v(" |\n\t\t\t\t\t"),
                      _c("span", { staticClass: "title error--text" }, [
                        _vm._v(" " + _vm._s(_vm.selected_purchase_date.t_value))
                      ])
                    ]
                  ),
                  _vm._v(" "),
                  _c(
                          ...
                          fn: function() {
                            return [
                              _c("v-select", {
                                ...
                                attrs: {
                                  "hide-details": "",
                                  items: _vm.dashboard.year_purchases,
                                  "item-text": "new_date",
                                  "return-object": "",
                                  outlined: "",
                                  dense: ""
                                ...
                                model: {
                                  value: _vm.selected_purchase_month,
                                  callback: function($$v) {
                                    _vm.selected_purchase_month = $$v
                                  },
                                  expression: "selected_purchase_month"
                                }
                              })
                            ]
                          },
                    ...
                    [
                      _vm._v(" "),
                      _c("span", { staticClass: "title primary--text" }, [
                        _vm._v(" " + _vm._s(_vm.selected_purchase_month.value))
                      ]),
                      _vm._v(" |\n\t\t\t\t\t"),
                      _c("span", { staticClass: "title error--text" }, [
                        _vm._v(
                          " " + _vm._s(_vm.selected_purchase_month.t_value)
                        )
                      ])
                    ]
                  ),
                  _vm._v(" "),
                  _c("d-panel", { attrs: { title: "مشتريات العام" } }, [
                    _c("span", { staticClass: "title primary--text" }, [
                      _vm._v(
                        " " +
                          _vm._s(
                            _vm.dashboard.year_purchases
                              ? _vm.dashboard.year_purchases.reduce(function(
                                  a,
                                  b
                                ) {
                                  return a + parseInt(b.value)
          ...
          _c(
            ...
            [
              _c("v-col", { attrs: { cols: "12", md: "6" } }, [
                _c("h3", { staticClass: "text-center grey--text ma-2" }, [
                  _vm._v("مبيعات ومشتريات العام")
                ])
              ]),
              _vm._v(" "),
              _c("v-col", { attrs: { cols: "12", md: "6" } }, [
                _c("h3", { staticClass: "text-center grey--text ma-3" }, [
                  _vm._v(" ضرائب العام")
                ])
              ])
            ],
          ...
          _c(
            ...
            [
              _c(
                ...
                [
                  ...
                  _c("v-chip", [
                    _vm._v(
                      "اضافة فاتورة شراء " +
                        _vm._s(_vm.selected_materials.length)
                    )
                  ]),
                  _vm._v(" "),
                  _c("l-table", {
                    attrs: {
                      selectable: "",
                      items: _vm.dashboard.required_materials,
              ...
              _c(
                ...
                [
                  _c("h3", { staticClass: "text-center grey--text ma-3" }, [
                    _vm._v("منتجات مطلوبة")
                  ]),
                  _vm._v(" "),
                  _c("v-chip", [
                    _vm._v(
                      "اضافة اوامر انتاج " +
                        _vm._s(_vm.selected_products.length)
                    )
                  ]),
                  _vm._v(" "),
                  _c("l-table", {
                    attrs: {
                      selectable: "",
                      items: _vm.dashboard.required_products,
                      headers: ["id", "name", "balance"]
                    },
                    model: {
                      value: _vm.selected_products,
                      callback: function($$v) {
                        _vm.selected_products = $$v
                      },
                      expression: "selected_products"
                    }
                  })
                ],
                1
...
/***/ "./resources/js/pages/dashboard/Summary.vue":
/*!**************************************************!*\
  !*** ./resources/js/pages/dashboard/Summary.vue ***!
  \**************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _Summary_vue_vue_type_template_id_a173011c_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Summary.vue?vue&type=template&id=a173011c&scoped=true& */ "./resources/js/pages/dashboard/Summary.vue?vue&type=template&id=a173011c&scoped=true&");
/* harmony import */ var _Summary_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Summary.vue?vue&type=script&lang=js& */ "./resources/js/pages/dashboard/Summary.vue?vue&type=script&lang=js&");
...
var component = (0,_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__.default)(
  ...
  _Summary_vue_vue_type_template_id_a173011c_scoped_true___WEBPACK_IMPORTED_MODULE_0__.render,
  _Summary_vue_vue_type_template_id_a173011c_scoped_true___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns,
  false,
  null,
  "a173011c",
  null
...
_node_modules_vuetify_loader_lib_runtime_installComponents_js__WEBPACK_IMPORTED_MODULE_3___default()(component, {VChip: vuetify_lib_components_VChip__WEBPACK_IMPORTED_MODULE_4__.default,VCol: vuetify_lib_components_VGrid__WEBPACK_IMPORTED_MODULE_5__.default,VRow: vuetify_lib_components_VGrid__WEBPACK_IMPORTED_MODULE_6__.default,VSelect: vuetify_lib_components_VSelect__WEBPACK_IMPORTED_MODULE_7__.default})


/* hot reload */
if (false) { var api; }
component.options.__file = "resources/js/pages/dashboard/Summary.vue"
