  ...
  methods: {
    fetchDepartmentItem: function fetchDepartmentItem() {
      ...
      axios.get("department-item/" + this.$route.params.item_id).then(function (res) {
        ...
        _this2.titles[2].text = res.data.name;
        _this2.titles[2].icon = "mdi-info";
      });
    },
    fetchDepartment: function fetchDepartment() {
      ...
      axios.get("department/" + this.$route.params.id).then(function (res) {
        _this3.department = res.data;
        setTimeout(function () {
          _this3.titles[1].text = res.data.name;
          _this3.titles[1].icon = res.data.icon;
          _this3.titles[1].href = "/departments/".concat(_this3.$route.params.id);
        }, 300);
      });
    }
  },
  ...
  return _c(
    ...
    [
      ...
      _vm.item.department.file_type == "image"
        ? _c(
            "v-card-text",
            { staticClass: "row p-0 mx-auto ml-0" },
            [
              _c(
                "v-slide-group",
                { staticClass: "pa-4 mx-auto", attrs: { "show-arrows": "" } },
                  ...
                  return _c(
                    ...
                    [
                      _c(
                        ...
                        {
                          staticClass: "ma-4",
                          attrs: { height: "200", width: "200", link: "" }
                        },
                        [
                          _c(
                            "a",
...
/* harmony import */ var vuetify_lib_components_VSlideGroup__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! vuetify/lib/components/VSlideGroup */ "./node_modules/vuetify/lib/components/VSlideGroup/VSlideGroup.js");
/* harmony import */ var vuetify_lib_components_VSlideGroup__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! vuetify/lib/components/VSlideGroup */ "./node_modules/vuetify/lib/components/VSlideGroup/VSlideItem.js");
...
_node_modules_vuetify_loader_lib_runtime_installComponents_js__WEBPACK_IMPORTED_MODULE_4___default()(component, {VAlert: vuetify_lib_components_VAlert__WEBPACK_IMPORTED_MODULE_5__.default,VBreadcrumbs: vuetify_lib_components_VBreadcrumbs__WEBPACK_IMPORTED_MODULE_6__.default,VBreadcrumbsItem: vuetify_lib_components_VBreadcrumbs__WEBPACK_IMPORTED_MODULE_7__.default,VCard: vuetify_lib_components_VCard__WEBPACK_IMPORTED_MODULE_8__.default,VCardText: vuetify_lib_components_VCard__WEBPACK_IMPORTED_MODULE_9__.VCardText,VCardTitle: vuetify_lib_components_VCard__WEBPACK_IMPORTED_MODULE_9__.VCardTitle,VIcon: vuetify_lib_components_VIcon__WEBPACK_IMPORTED_MODULE_10__.default,VImg: vuetify_lib_components_VImg__WEBPACK_IMPORTED_MODULE_11__.default,VSlideGroup: vuetify_lib_components_VSlideGroup__WEBPACK_IMPORTED_MODULE_12__.default,VSlideItem: vuetify_lib_components_VSlideGroup__WEBPACK_IMPORTED_MODULE_13__.default})
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _VItemGroup_VItem__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../VItemGroup/VItem */ "./node_modules/vuetify/lib/components/VItemGroup/VItem.js");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((0,_util_mixins__WEBPACK_IMPORTED_MODULE_0__.default)(_VItemGroup_VItem__WEBPACK_IMPORTED_MODULE_1__.BaseItem, (0,_mixins_groupable__WEBPACK_IMPORTED_MODULE_2__.factory)('slideGroup')
/* @vue/component */
).extend({
  name: 'v-slide-item'
}));
