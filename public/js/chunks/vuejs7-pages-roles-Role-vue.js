(self["webpackChunk"] = self["webpackChunk"] || []).push([["vuejs7-pages-roles-Role-vue"],{

/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/roles/Role.vue?vue&type=script&lang=js&":
/*!************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/roles/Role.vue?vue&type=script&lang=js& ***!
  \************************************************************************************************************************************************************************************************************/
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  computed: {
    users: (0,vuex_pathify__WEBPACK_IMPORTED_MODULE_0__.get)('users'),
  ...
  methods: {
    fetchRole: function fetchRole() {
      ...
      this.axios.get('roles/' + this.$route.params.id).then(function (res) {
        return _this.role = res.data;
      });
    },
    adduserToRole: function adduserToRole() {
      this.selected_user = '';
      this.show_select_user = true;
    },
    saveUserToRole: function saveUserToRole() {
      var _this2 = this;

      if (!this.selected_user) return alert('Please select user first');
      this.axios.put('roles/' + this.role.id, {
        add_user: true,
        user_id: this.selected_user.id
      }).then(function (res) {
        _this2.role = res.data;
        _this2.show_select_user = false;
      });
    },
    editRole: function editRole(item) {
      var _this3 = this;

      this.role = _objectSpread({}, item);
      if (!Array.isArray(item.permissions)) item.permissions = [];
      this.selected = item.permissions;
      this.show_role_dialog = true;
      setTimeout(function () {
        _this3.pages = {};
        Object.keys(_this3.role.permissions).forEach(function (key) {
          _this3.pages[key] = '1';
        });
        _this3.selected = _this3.role.permissions;
      }, 250);
    },
    ...
    deleteUserRole: function deleteUserRole(id) {
      var _this4 = this;

      if (confirm('Are you sure to delete this role?')) this.axios.put('roles/' + this.role.id, {
        remove_user: true,
        user_id: id
      }).then(function () {
        _this4.role.users = _this4.role.users.filter(function (u) {
          return u.id !== id;
        });
      });
    },
    save: function save() {
      ...
      if (this.role.id) {
        this.axios.put('roles/' + this.role.id, this.role).then(function (res) {
          _this5.$store.set('UPDATE_ROLE', res.data);

          _this5.show_role_dialog = false;
        })["catch"](function (err) {
          return alert(err.response.data.errors.name);
        });
      } else this.axios.post('roles', this.role).then(function (res) {
        _this5.$store.set('ADD_ROLE', res.data);
...
/***/ "./resources/js/pages/roles/Role.vue?vue&type=script&lang=js&":
/*!********************************************************************!*\
  !*** ./resources/js/pages/roles/Role.vue?vue&type=script&lang=js& ***!
  \********************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./resources/js/pages/roles/Role.vue?vue&type=template&id=4a1bd6d1&":
/*!**************************************************************************!*\
  !*** ./resources/js/pages/roles/Role.vue?vue&type=template&id=4a1bd6d1& ***!
  \**************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "render": () => (/* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_Role_vue_vue_type_template_id_4a1bd6d1___WEBPACK_IMPORTED_MODULE_0__.render),
/* harmony export */   "staticRenderFns": () => (/* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_Role_vue_vue_type_template_id_4a1bd6d1___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns)
/* harmony export */ });
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_Role_vue_vue_type_template_id_4a1bd6d1___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./Role.vue?vue&type=template&id=4a1bd6d1& */ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/roles/Role.vue?vue&type=template&id=4a1bd6d1&");


/***/ }),

/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/roles/Role.vue?vue&type=template&id=4a1bd6d1&":
/*!*****************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/roles/Role.vue?vue&type=template&id=4a1bd6d1& ***!
  \*****************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var render = function() {
  ...
  return _c(
    ...
    [
      _c(
        "v-toolbar",
        { attrs: { flat: "", color: "primary lighten-5" } },
        [
          _c(
            "v-icon",
            {
      ...
      _c(
        ...
        [
          ...
          _c(
            ...
            _vm._l(_vm.role.permissions, function(item) {
                    ...
                    return [
                      _c(
                        "v-icon",
                        {
                          ...
                          on: {
                            click: function($event) {
                              return _vm.$router.push("/users/list/" + item.id)
                            }
                          }
                        },
                        [_vm._v("visibility")]
                      ...
                      _c(
                        "v-icon",
                        {
                          ...
                          on: {
                            click: function($event) {
                              return _vm.deleteUserRole(item.id)
                            }
                          }
                        },
                        [_vm._v("close")]
      ...
      _c(
        "v-dialog",
        {
          ...
          model: {
            value: _vm.show_select_user,
            callback: function($$v) {
              _vm.show_select_user = $$v
            },
            expression: "show_select_user"
          }
        },
        [
          _c(
...
/***/ "./resources/js/pages/roles/Role.vue":
/*!*******************************************!*\
  !*** ./resources/js/pages/roles/Role.vue ***!
  \*******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _Role_vue_vue_type_template_id_4a1bd6d1___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Role.vue?vue&type=template&id=4a1bd6d1& */ "./resources/js/pages/roles/Role.vue?vue&type=template&id=4a1bd6d1&");
/* harmony import */ var _Role_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Role.vue?vue&type=script&lang=js& */ "./resources/js/pages/roles/Role.vue?vue&type=script&lang=js&");
...
var component = (0,_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__.default)(
  ...
  _Role_vue_vue_type_template_id_4a1bd6d1___WEBPACK_IMPORTED_MODULE_0__.render,
  _Role_vue_vue_type_template_id_4a1bd6d1___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns,
  false,
  null,
  null,
  null
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (_VAutocomplete_VAutocomplete__WEBPACK_IMPORTED_MODULE_1__.default.extend({
  ...
  methods: {
    ...
    onFilteredItemsChanged(val, oldVal) {
      ...
      _VAutocomplete_VAutocomplete__WEBPACK_IMPORTED_MODULE_1__.default.options.methods.onFilteredItemsChanged.call(this, val, oldVal);
    },

    onKeyDown(e) {
      const keyCode = e.keyCode;
      _VSelect_VSelect__WEBPACK_IMPORTED_MODULE_2__.default.options.methods.onKeyDown.call(this, e); // If user is at selection index of 0
      // create a new tag
    ...
    selectItem(item) {
      ...
      if (this.editingIndex > -1) {
        ...
        _VAutocomplete_VAutocomplete__WEBPACK_IMPORTED_MODULE_1__.default.options.methods.selectItem.call(this, item);
      }
    },
    ...
    setValue(value) {
      ...
      _VSelect_VSelect__WEBPACK_IMPORTED_MODULE_2__.default.options.methods.setValue.call(this, (_value = value) != null ? _value : this.internalSearch);
    },
