(self["webpackChunk"] = self["webpackChunk"] || []).push([["vuejs7-pages-auth-Login-vue"],{
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    login: function login() {
      ...
      var app = this; // alert(window.location.hostname)

      this.axios.get(window.location.protocol + "//" + window.location.hostname + "/sanctum/csrf-cookie").then(function (res) {
        _this.$auth.login({
          data: {
            email: _this.email,
            password: _this.password //  useCredentails: true
    ...
    SendResetCode: function SendResetCode() {
      ...
      this.axios.post("/send-reset-password-link", {
        email: this.email
      }).then(function (res) {
        alert(res.data);
      })["catch"](function (err) {
...
var render = function() {
  ...
  return _c(
    "div",
    { staticClass: "justify-center d-flex align-center flex-column" },
    [
      _c(
        "v-alert",
        {
      ...
      _vm.$auth.check() == false
        ? _c(
            "v-card",
            { staticClass: "rounded-lg log", attrs: { outlined: "" } },
            [
              _c(
                "v-img",
                { attrs: { src: __webpack_require__(/*! ../../assets/omma.jpg */ "./resources/js/assets/omma.jpg").default } },
                [
                  _c(
                    "v-card-title",
                    {
                      staticClass: "justify-center flex-column white--text",
                    ...
                    [
                      ...
                      _c(
                        "v-icon",
                        {
                          staticClass: "title white--text mt-3",
                          staticStyle: { "font-size": "7rem !important" },
                          attrs: { dark: "", color: "black darken-3" }
                        },
                        ...
                        [
                          _c("v-text-field", {
                            ...
                            attrs: {
                              ...
                              rules: [
                                function(v) {
                                  return !!v || "البريد الإلكتروني مطلوب"
                                },
                                function(v) {
                                  return (
                          ...
                          _c("v-text-field", {
                            attrs: {
                              ...
                              rules: [
                                ...
                                function(v) {
                                  return (
                                    (v && v.length >= 6) || "يرجي إدخال 6 رموز"
                                  )
                                }
                              ],
                              required: ""
                    ...
                    [
                      _c(
                        "v-chip",
                        {
                          ...
                          attrs: { label: "", color: "blue darken-3" },
                          on: {
                      ...
                      _c(
                        "v-btn",
                        {
                          attrs: { text: "", label: "", color: "white" },
                          on: {
                            click: function($event) {
                              $event.stopPropagation()
                              return _vm.resetEmail($event)
                            }
                          }
                        },
                        [_vm._v("استعادة الرقم السري")]
                      )
                    ],
                    1
                  )
...
/* harmony import */ var vuetify_lib_components_VChip__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! vuetify/lib/components/VChip */ "./node_modules/vuetify/lib/components/VChip/VChip.js");
