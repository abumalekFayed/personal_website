(self["webpackChunk"] = self["webpackChunk"] || []).push([["vuejs7-pages-roles-Roles-vue"],{

/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/roles/Roles.vue?vue&type=script&lang=js&":
/*!*************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/roles/Roles.vue?vue&type=script&lang=js& ***!
  \*************************************************************************************************************************************************************************************************************/
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  computed: _objectSpread(_objectSpread({}, (0,vuex_pathify__WEBPACK_IMPORTED_MODULE_0__.get)(["roles"])), {}, {
    visibleRoutes: function visibleRoutes() {
      return this.routes.filter(function (r) {
        return r.hide != true && r.noRole != true && r.meta;
      });
    }
  }),
  methods: {
    ...
    selectMain: function selectMain(route) {
      var _this = this;
    ...
    selectSuper: function selectSuper(route) {
      if (!route.roles) return;
      var newar = route.roles.map(function (r) {
        return route.path + "." + r;
      });
      ...
      if (this.selected.includes(route.path)) {
        this.selected = [].concat(_toConsumableArray(this.selected), _toConsumableArray(newar));
      }
    },
    editRole: function editRole(item) {
      ...
      this.show_role_dialog = true; // setTimeout(() => {
      //     this.pages = {}
    ...
    deleteRole: function deleteRole(id) {
      ...
      this.axios["delete"]("role/" + id).then(function () {
        return _this2.$store.set("REMOVE", {
          _t: "roles",
          id: id
        });
      });
    ...
    save: function save() {
      ...
      if (this.role.id) {
        this.axios.put("role/" + this.role.id, this.role).then(function (res) {
          res.data._t = "roles";

          _this3.$store.set("UPDATE", res.data);

          _this3.show_role_dialog = false;
        })["catch"](function (err) {
          return alert(err.response.data.errors.name);
        });
      } else this.axios.post("role", this.role).then(function (res) {
        res.data._t = "roles";

        _this3.$store.set("ADD", res.data);
...
/***/ "./resources/js/pages/roles/Roles.vue?vue&type=script&lang=js&":
/*!*********************************************************************!*\
  !*** ./resources/js/pages/roles/Roles.vue?vue&type=script&lang=js& ***!
  \*********************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./resources/js/pages/roles/Roles.vue?vue&type=template&id=05eab71c&":
/*!***************************************************************************!*\
  !*** ./resources/js/pages/roles/Roles.vue?vue&type=template&id=05eab71c& ***!
  \***************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "render": () => (/* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_Roles_vue_vue_type_template_id_05eab71c___WEBPACK_IMPORTED_MODULE_0__.render),
/* harmony export */   "staticRenderFns": () => (/* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_Roles_vue_vue_type_template_id_05eab71c___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns)
/* harmony export */ });
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_Roles_vue_vue_type_template_id_05eab71c___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./Roles.vue?vue&type=template&id=05eab71c& */ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/roles/Roles.vue?vue&type=template&id=05eab71c&");


/***/ }),

/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/roles/Roles.vue?vue&type=template&id=05eab71c&":
/*!******************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/roles/Roles.vue?vue&type=template&id=05eab71c& ***!
  \******************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
    ...
    [
      ...
      _c(
        "v-data-table",
        {
          ...
          attrs: { headers: _vm.headers, items: _vm.roles, search: _vm.search },
          scopedSlots: _vm._u(
            [
              {
                key: "item.action",
                      ...
                      "v-icon",
                      {
                        ...
                        on: {
                          click: function($event) {
                            return _vm.$router.push("/users/roles/" + item.id)
                          }
                        }
                      },
                      [_vm._v("mdi-eye")]
      ...
      _c(
        "d-dialog",
        {
          attrs: { width: "1100px", title: "اضافة صلاحية" },
          on: { save: _vm.save },
          model: {
            value: _vm.show_role_dialog,
            callback: function($$v) {
              _vm.show_role_dialog = $$v
            },
            expression: "show_role_dialog"
          }
        },
        [
          _c("v-text-field", {
          ...
          _c("v-checkbox", {
            staticClass: "ma-2",
            attrs: { color: "error", label: "ادمن", value: "admin" },
          ...
          _vm._v(" "),
          _vm._l(_vm.visibleRoutes, function(route, i) {
            return _c(
              "v-card",
              { key: i, staticClass: "ma-2", attrs: { outlined: "" } },
              [
                _c("v-checkbox", {
                  attrs: {
                    color: "success",
                ...
                route.roles
                  ? _c(
                      ...
                      _vm._l(route.roles, function(role, w) {
                        return _c(
                          "v-chip",
                          {
                            key: w,
                            attrs: {
                              disabled: !_vm.selected.includes(route.path),
                              value: route.path + "." + role,
                              small: "",
                              label: ""
                            }
                          },
                  ...
                  : _vm._e(),
                _vm._v(" "),
                route.children && _vm.selected.includes(route.path)
                  ? _vm._l(
                      route.children.filter(function(c) {
                        return c.hide != true
                      }),
                      function(p2, i2) {
                        return _c("div", { key: i2 }, [
                          _c(
                            "div",
                            { staticClass: "d-flex align-center ma-2" },
                            [
                              _c("v-checkbox", {
                                staticClass: "ml-4",
                                staticStyle: { width: "220px", margin: "0px" },
                                attrs: {
                                  "hide-details": "",
                                  label: p2.path.replace(route.path, ""),
                                  value: p2.path
                                },
                                on: {
                                  change: function($event) {
                                    return _vm.selectSuper(p2)
                                  }
                                },
                                model: {
                                  value: _vm.selected,
                              ...
                              p2.roles
                                ? _c(
                                    ...
                                    _vm._l(p2.roles, function(p3, i3) {
                                      return _c(
                                        "v-chip",
                                        {
                                          key: i3,
...
/***/ "./resources/js/pages/roles/Roles.vue":
/*!********************************************!*\
  !*** ./resources/js/pages/roles/Roles.vue ***!
  \********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _Roles_vue_vue_type_template_id_05eab71c___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Roles.vue?vue&type=template&id=05eab71c& */ "./resources/js/pages/roles/Roles.vue?vue&type=template&id=05eab71c&");
/* harmony import */ var _Roles_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Roles.vue?vue&type=script&lang=js& */ "./resources/js/pages/roles/Roles.vue?vue&type=script&lang=js&");
...
var component = (0,_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__.default)(
  ...
  _Roles_vue_vue_type_template_id_05eab71c___WEBPACK_IMPORTED_MODULE_0__.render,
  _Roles_vue_vue_type_template_id_05eab71c___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns,
  false,
  null,
  null,
  null
...
_node_modules_vuetify_loader_lib_runtime_installComponents_js__WEBPACK_IMPORTED_MODULE_3___default()(component, {VBtn: vuetify_lib_components_VBtn__WEBPACK_IMPORTED_MODULE_4__.default,VCard: vuetify_lib_components_VCard__WEBPACK_IMPORTED_MODULE_5__.default,VCheckbox: vuetify_lib_components_VCheckbox__WEBPACK_IMPORTED_MODULE_6__.default,VChip: vuetify_lib_components_VChip__WEBPACK_IMPORTED_MODULE_7__.default,VChipGroup: vuetify_lib_components_VChipGroup__WEBPACK_IMPORTED_MODULE_8__.default,VDataTable: vuetify_lib_components_VDataTable__WEBPACK_IMPORTED_MODULE_9__.default,VIcon: vuetify_lib_components_VIcon__WEBPACK_IMPORTED_MODULE_10__.default,VTextField: vuetify_lib_components_VTextField__WEBPACK_IMPORTED_MODULE_11__.default})


/* hot reload */
if (false) { var api; }
component.options.__file = "resources/js/pages/roles/Roles.vue"
