  ...
  return _c(
    ...
    [
      _vm.$auth.check() == false
        ? _c(
            "v-card",
            { staticStyle: { width: "500px" }, attrs: { outlined: "" } },
            [
              _c(
                "v-card-title",
              ...
              _c(
                ...
                [
                  ...
                  _c(
                    "v-btn",
                    {
                      attrs: { text: "", label: "", color: "primary" },
                      on: {
                        click: function($event) {
                          $event.stopPropagation()
